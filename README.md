...
*   [stlewandowski/GitMAD](https://github.com/stlewandowski/GitMAD) - Monitor, Alert, and Discover sensitive info and data leakage on Github.

*   [malwaredllc/byob](https://github.com/malwaredllc/byob) - An open-source post-exploitation framework for students, researchers and developers.

*   [hi-KK/VulDB\_Spider](https://github.com/hi-KK/VulDB_Spider) - vulnerability database spider 爬取NVD、CNVD、CNNVD等漏洞数据库

*   [cilame/vthread](https://github.com/cilame/vthread) - python 更加方便的多线程库，以最小的代码侵入，做到最高效的多线程、线程池 coding 效率。在不改变源代码的情况下，一行代码即可实现线程池操作。
...
*   [HG-ha/ICP\_Query](https://github.com/HG-ha/ICP_Query) - 从工业和信息化部政务服务平台抓取实时数据，提供本地API，自动过验证码，支持Web、APP、小程序、快应用名称查询，违法违规应用查询，支持根据备案号查询，支持根据企业名称查询
...
*   [StarfireLab/AutoZerologon](https://github.com/StarfireLab/AutoZerologon) - Zerologon自动化脚本
...
*   [AYcg/poc](https://github.com/AYcg/poc) -

*   [gmh5225/rust-mordor-rs](https://github.com/gmh5225/rust-mordor-rs) - Rusty Hell's Gate / Halo's Gate / Tartarus' Gate / FreshyCalls / Syswhispers2 Library

*   [ASkyeye/SassyKitdi](https://github.com/ASkyeye/SassyKitdi) -

*   [0x727/MetasploitCoop\_0x727](https://github.com/0x727/MetasploitCoop_0x727) - 基于msf的后渗透协作平台
...
*   [BC-SECURITY/Moriarty](https://github.com/BC-SECURITY/Moriarty) -
...
*   [uknowsec/SharpEventLog](https://github.com/uknowsec/SharpEventLog) - c# 读取登录过本机的登录失败或登录成功（4624，4625）的所有计算机信息，在内网渗透中快速定位运维管理人员。

*   [m3rcer/Chisel-Strike](https://github.com/m3rcer/Chisel-Strike) - A .NET XOR encrypted cobalt strike aggressor implementation for chisel to utilize faster proxy and advanced socks5 capabilities.

*   [matterpreter/OffensiveCSharp](https://github.com/matterpreter/OffensiveCSharp) - Collection of Offensive C# Tooling

*   [3lpsy/FactionCore](https://github.com/3lpsy/FactionCore) - Faction C2 Framework Core Server
...
*   [Boogipop/CVE-2023-22527-Godzilla-MEMSHELL](https://github.com/Boogipop/CVE-2023-22527-Godzilla-MEMSHELL) - CVE-2023-22527 内存马注入工具
...
*   [zeoxisca/gamma-gui](https://github.com/zeoxisca/gamma-gui) - a tool help you write gamma poc

*   [Mzzzj/CS2\_DMA\_Radar](https://github.com/Mzzzj/CS2_DMA_Radar) - CS2 DMA 雷达
...
*   [TianNaYa/WallPaper](https://github.com/TianNaYa/WallPaper) - Set html file to desktop
...
*   [thetowsif/nuclei-template-fetcher](https://github.com/thetowsif/nuclei-template-fetcher) -
...
*   [ainrm/cobaltstrike-suricata-rules](https://github.com/ainrm/cobaltstrike-suricata-rules) - 17条检测cobaltstrike的suricata-ids规则
...
*   [Ridter/warp\_proxy](https://github.com/Ridter/warp_proxy) - cloudflare socks5 server

*   [iredmail/dockerized](https://github.com/iredmail/dockerized) - Official dockerized iRedMail.
